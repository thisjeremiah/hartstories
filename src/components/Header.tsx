...
export function Header() {
  return (
    <header className="relative z-50 flex-none lg:pt-11">
      <Container>
        <div className="flex flex-wrap items-center justify-center sm:justify-between lg:flex-nowrap">
        ...
        <div className="pt-6 text-blackish">
          <div className="text-center">
            <p>
              Winner Best Solo Show and Best Love Story
            </p>
            <p>
              FringePVD Festival 2024
            </p>
          </div>
        </div>
      </Container>
