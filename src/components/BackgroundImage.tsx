...
export function BackgroundImage({
  ...
  return (
    <div
      className={clsx(
        'absolute inset-0 overflow-hidden bg-whitish',
        className,
      )}
    >
      {
      ...
      <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-whitish" />
      <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-whitish" />
    </div>
  )
}
